        ...
        <div class="col-md-3 col-sm-12 col-xs-12">
            <div class="home-info">
                ...
                <div class="home-info-inner">
                    ...
                    <a href="/foodmenu" class="hidden-md hidden-lg booking-switch home-left-button" style="font-family: lato; font-weight: 900; font-size: 12px; letter-spacing: 2px; padding: 15px; border: 2px solid #333; text-align: center; cursor: pointer; margin-bottom: 15px; "><span>МЕНЮ РЕСТОРАНА</span></a>
